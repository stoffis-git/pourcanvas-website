...
<table>
<tr><th>Factor</th><th>Exposed Aggregate</th><th>Stamped Concrete</th></tr>
<tr><td>Cost/sq ft</td><td>$8–14</td><td>$12–18</td></tr>
<tr><td>Slip resistance</td><td>High (natural texture)</td><td>Medium (depends on pattern depth)</td></tr>
<tr><td>Repair difficulty</td><td>Hard — new aggregate won't match</td><td>Hard — color match is difficult</td></tr>
<tr><td>Pattern variety</td><td>Limited to aggregate choice</td><td>Wide — dozens of stamp patterns</td></tr>
<tr><td>Maintenance</td><td>Reseal every 2–3 years</td><td>Reseal every 2–3 years</td></tr>
<tr><td>Best for</td><td>Driveways, pool decks</td><td>Patios, walkways, entries</td></tr>
</table>
...
Both finishes require resealing every 2–3 years and both are difficult to patch invisibly. The deciding factor is usually location: driveways and pool decks favor exposed aggregate for grip; patios and entryways favor stamped for design flexibility.`,
  ...
  faqs: [
    ...
    {
      question: "How do you make exposed aggregate concrete?",
      answer: "Concrete is poured with decorative aggregate mixed in, then a surface retarder is sprayed on the fresh surface to prevent the top layer from hardening. After the bulk of the slab sets — typically 4–8 hours after the pour, though this varies significantly with temperature and humidity — the top paste is washed away with water and a stiff brush to reveal the embedded stones. Timing the wash is the critical skill: too early and aggregate falls out, too late and the surface has already hardened past the point where the paste can be removed.",
    },
    {
