...
<tr><td>Resale impact</td><td>Neutral</td><td>Positive — decorative detail adds perceived value</td></tr>
  ...
  relatedArticles: [
    ...
    { pillar: "patio", slug: "best-concrete-finish-pool-deck" },
  ],
  faqs: [
    {
    ...
    {
      question: "What is broom finish concrete?",
      answer: "Broom finish is the most common poured concrete surface, created by dragging a stiff-bristled broom across fresh concrete to leave fine parallel lines that provide slip resistance. It's the standard finish for driveways, walkways, and pool decks — what you get if you don't specify a decorative upgrade.",
    },
    {
