...
export const inspirationPages: InspirationPage[] = [
  ...
  },
  {
    ...
    title: "Scored Concrete Driveway With Grass Channels | PourCanvas",
    headline: "Scored Concrete Driveway, Grass Channels",
    metaDescription: "Scored grid concrete driveway with turf-filled channels - a geometric front approach that reads as designed. See how it looks on real contemporary homes.",
    ogImage: "https://images.pourcanvas.com/inspiration-scored-concrete-driveway-grass-channels.jpg",
    heroAlt: "Scored concrete driveway with grass turf filling the scored channels, contemporary home, golden hour light",
    dominantColor: "#9e947b",
    contentBlock:
    ...
    targetKeywords: ["scored concrete driveway grass channels", "concrete driveway with turf joints", "scored grid concrete driveway"],
    pillar: "driveway",
  ...
  },
  {
    ...
    title: "Concrete Strip Driveway With Turf | PourCanvas",
    headline: "Concrete Strips With Turf Driveway",
    metaDescription: "Two or three parallel concrete strips with turf between them - a clean, low-cost front approach that lets the lawn breathe through the driveway.",
    ogImage: "https://images.pourcanvas.com/inspiration-concrete-strips-turf-driveway.jpg",
    heroAlt: "Parallel concrete strip driveway with turf between strips, craftsman home, overcast light",
    dominantColor: "#a1a091",
    contentBlock:
    ...
    targetKeywords: ["concrete strips with turf driveway", "concrete strip driveway", "concrete and grass driveway ideas"],
    pillar: "driveway",
  ...
  },
  {
    ...
    title: "Tiered Concrete Slab Entry Steps | PourCanvas",
    headline: "Tiered Concrete Slab Entry",
    metaDescription: "Wide tiered concrete slab entry steps create a generous, landscape-forward approach to the front door. See how this format looks on contemporary homes.",
    ogImage: "https://images.pourcanvas.com/inspiration-tiered-concrete-slab-entry.jpg",
    heroAlt: "Tiered wide concrete slab entry steps leading to front door, contemporary home with post-rain wet surface reflection",
    dominantColor: "#696759",
    contentBlock:
    ...
    targetKeywords: ["tiered concrete slab entry", "wide concrete entry steps", "cascading concrete platform walkway"],
    pillar: "walkway",
  ...
  },
  {
    ...
    title: "Warm Tan Broom Finish Concrete Patio | PourCanvas",
    headline: "Warm Tan Broom Finish Patio",
    metaDescription: "A warm tan broom-finish concrete patio is the most versatile backyard surface — it works with every furniture style, home colour, and garden type.",
    ogImage: "https://images.pourcanvas.com/inspiration-warm-tan-broom-finish-patio.jpg",
    heroAlt: "Warm tan broom-finish concrete patio with integral buff pigment, craftsman home backyard, harsh midday sun revealing surface texture",
    contentBlock:
      "A warm tan broom-finish concrete patio is the outdoor surface that works with everything - every furniture choice, every planting scheme, every home colour. Where grey reads as cool and modern, and charcoal as bold, tan sits in a warm middle ground that reads as naturally settled into most residential backyards.\n\nThe colour comes from an integral buff or warm tan pigment in the pour - not a surface wash or stain. Integral pigment runs through the full depth of the slab, so chips and surface wear don't expose a grey undercolour. The broom finish dragged across fresh concrete adds directional fine-line texture that catches raking light at dawn and dusk, giving the surface visual life without the cost or complexity of stamping.\n\nThe practical case for warm tan is straightforward. It hides bird droppings and organic staining better than any grey tone. It reads as warm against brick, timber, rendered walls, and virtually every exterior colour. It photographs well in all lighting conditions - unlike charcoal, which can look flat in overcast light, tan absorbs morning and afternoon warmth and glows slightly in golden hour.\n\nCost: $6-10 per sq ft for a standard broom-finish pour, plus $1-2 per sq ft for integral tan pigment. On a 350 sq ft patio, budget $2,450-4,200. A penetrating sealer applied at installation and refreshed every 3-5 years deepens the warm tone and protects the surface. PourCanvas can show you how different tan tones would look on your specific patio space.",
    targetKeywords: ["warm tan concrete patio", "buff broom finish patio", "tan concrete patio ideas"],
    pillar: "patio",
  ...
  },
  {
    ...
    title: "Light Grey Concrete Path Ideas | PourCanvas",
    headline: "Light Grey Concrete Paths",
    metaDescription: "Light grey poured concrete front paths and entries - broom finish, lightly polished, and raw trowel finishes for any home style. See real examples.",
    ogImage: "https://images.pourcanvas.com/premium-slab-033.jpg",
    heroAlt: "Light grey broom-finish poured concrete covered entry porch with one step down, cedar-clad home, late afternoon light",
    dominantColor: "#87857c",
    contentBlock:
    ...
    targetKeywords: ["light grey concrete path", "grey concrete front path", "light grey poured concrete walkway"],
    pillar: "walkway",
    ctaHeadline: "See light grey concrete at your entry",
    ctaBody: "Upload a photo of your front path or entry and see what light grey poured concrete could look like in your space.",
    additionalImages: [
      { url: "https://images.pourcanvas.com/premium-slab-034.jpg", alt: "Light grey raw poured concrete side-entry path, ranch-style home, native grasses, golden hour" },
      { url: "https://images.pourcanvas.com/premium-slab-037.jpg", alt: "Light grey polished poured concrete front path, Corten steel and render home, clear morning sun" },
      { url: "https://images.pourcanvas.com/premium-slab-042.jpg", alt: "Light grey raw poured concrete open front stoop, white rendered bungalow, late afternoon" },
  ...
  },
  {
    ...
    title: "Dark Concrete Home Exterior Ideas | PourCanvas",
    headline: "Dark Concrete Home Exterior",
    metaDescription: "Near-black and charcoal poured concrete across driveways, patios, and paths - the defining surface look for dark architecture. See real examples.",
    ogImage: "https://images.pourcanvas.com/premium-slab-026.jpg",
    heroAlt: "Near-black broom-finish poured concrete patio beside a dark-clad contemporary home at blue hour",
    dominantColor: "#3c3d35",
    contentBlock:
    ...
    targetKeywords: ["dark concrete home exterior", "near-black concrete driveway patio", "charcoal concrete outdoor surfaces"],
    ctaHeadline: "See dark concrete across your home exterior",
    ctaBody: "Upload a photo of your home exterior and see what near-black or charcoal poured concrete could look like across your outdoor surfaces.",
    additionalImages: [
      { url: "https://images.pourcanvas.com/premium-slab-031.jpg", alt: "Near-black lightly polished poured concrete patio, dark timber board-clad home, late afternoon" },
      { url: "https://images.pourcanvas.com/premium-slab-032.jpg", alt: "Near-black broom poured concrete patio, Corten steel home, 3/4 angle, midday sun" },
      { url: "https://images.pourcanvas.com/premium-slab-035.jpg", alt: "Near-black broom poured concrete covered entry porch, flat-roof concrete-timber home, blue-sky morning" },
      { url: "https://images.pourcanvas.com/premium-slab-036.jpg", alt: "Near-black raw poured concrete driveway, grey fibre cement bungalow, Toyota RAV4, midday sun" },
      { url: "https://images.pourcanvas.com/premium-slab-040.jpg", alt: "Near-black raw poured concrete driveway, white rendered bungalow, Toyota RAV4, late afternoon shadows" },
      { url: "https://images.pourcanvas.com/premium-slab-045.jpg", alt: "Near-black polished poured concrete side path, Corten steel home, 3/4 angle, midday sun" },
