...
export const patioArticles: Article[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Random flagstone stamping is the most popular pattern in North America. It fits almost any landscape style and is forgiving of slight color variations — which makes it easier to repair or extend years down the line. It's the safest choice if you're uncertain about style direction.",
      },
      {
        heading: "Wood Plank",
        body: "Stamped wood-plank concrete looks remarkably realistic and eliminates the maintenance headaches of actual wood decking. It works especially well around pools where real wood would warp or splinter. The difference between convincing and cheap-looking wood plank comes down to multi-layer color — one base pour color alone won't do it.",
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      "Choosing the right concrete patio color can make or break your backyard. We cover the most popular shades for 2026 and how to pull each one off.",
  ...
  },
  {
    ...
    metaDescription:
      "Resurfacing costs $3–15/sq ft vs. $6–18 for replacement. Here's how to assess your existing slab and decide which option makes sense.",
